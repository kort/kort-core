...
insert into kort.badge (badge_id, name, title, description, color, sorting, compare_value) VALUES (8, 'fix_count_motorway_ref_100', 'badge.name.100_motorway_ref_missions', 'badge.description.100_motorway_ref_missions_completed', '#FFFBCB', 200, 100);
...
insert into kort.badge (badge_id, name, title, description, color, sorting, compare_value) VALUES (10, 'fix_count_motorway_ref_5', 'badge.name.5_motorway_ref_missions', 'badge.description.5_motorway_ref_missions_completed', '#d8c69a', 220, 5);
