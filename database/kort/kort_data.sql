...
insert into kort.error_type (error_type_id, type, description, osm_tag, view_type, answer_placeholder, vote_question, bug_question, fix_koin_count, vote_koin_count, required_votes) values (1002, 'opening_hours', 'error_type.title.opening_hours', 'opening_hours', 'text', 'error_type.placeholder.opening_hours', 'vote.question.opening_hours', 'bug.question.opening_hours', 25, 5, 3);
