...
(select count(*) from kort.fix where valid) validated_fix_count,
...
(select count(*) from kort.fix where valid and error_type='missing_cuisine') solved_missing_cuisine_count,
