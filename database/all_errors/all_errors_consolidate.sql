...
FROM osm_errors.errors o2 WHERE NOT EXISTS (SELECT 1 FROM all_errors.errors e WHERE e.schema=o2.schema AND e.error_id=o2.error_id AND e.osm_id=o2.object_id);
