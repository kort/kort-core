...
FROM osm_errors.errors o2 WHERE NOT EXISTS (SELECT 1 FROM all_errors.errors e WHERE e.schema=o2.schema AND e.osm_id=o2.object_id AND e.error_type_id=o2.error_type_id);